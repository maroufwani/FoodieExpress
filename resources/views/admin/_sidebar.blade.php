...
<a href="/admin/dashboard" class="portal-nav-link @yield('admin-nav-dashboard')">
...
<a href="/admin/users" class="portal-nav-link @yield('admin-nav-users')">
...
<a href="/admin/restaurants" class="portal-nav-link @yield('admin-nav-restaurants')">
...
<a href="/admin/orders" class="portal-nav-link @yield('admin-nav-orders')">
...
<a href="/admin/delivery-partners" class="portal-nav-link @yield('admin-nav-delivery')">
